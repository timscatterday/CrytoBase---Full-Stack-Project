            ...
            <table className='crypto_chart'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>% {this.props.assets['BTC']['USD']['CHANGEPCT24HOUR']}</td>
                        <td>Nan</td>
                    </tr>
                    <tr>
                        ...
                        <td>% {this.props.assets['ETH']['USD']['CHANGEPCT24HOUR']}</td>
                        <td>Nan</td>
                    </tr>
                    <tr>
                        ...
                        <td>% {this.props.assets['BCH']['USD']['CHANGEPCT24HOUR']}</td>
                        <td>Nan</td>
                    </tr>
                    <tr>
                        ...
                        <td>% {this.props.assets['LTC']['USD']['CHANGEPCT24HOUR']}</td>
                        <td>Nan</td>
                    </tr>
                    <tr>
                        ...
                        <td>% {this.props.assets['EOS']['USD']['CHANGEPCT24HOUR']}</td>
                        <td>Nan</td>
                    </tr>
                </tbody>
            </table>
