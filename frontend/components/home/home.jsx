            ...
            <table className='crypto_chart'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style={{ color: this.props.assets['BTC']['USD']['CHANGEPCT24HOUR'] > 0 ? 'green' : 'red' }}>% {this.props.assets['ETH']['USD']['CHANGEPCT24HOUR']}</td>
                        <td>Nan</td>
                    </tr>
                    <tr>
                        ...
                        <td style={{ color: this.props.assets['BTC']['USD']['CHANGEPCT24HOUR'] > 0 ? 'green' : 'red' }}>% {this.props.assets['BCH']['USD']['CHANGEPCT24HOUR']}</td>
                        <td>Nan</td>
                    </tr>
                    <tr>
                        ...
                        <td style={{ color: this.props.assets['BTC']['USD']['CHANGEPCT24HOUR'] > 0 ? 'green' : 'red' }}>% {this.props.assets['LTC']['USD']['CHANGEPCT24HOUR']}</td>
                        <td>Nan</td>
                    </tr>
                    <tr>
                        ...
                        <td style={{ color: this.props.assets['BTC']['USD']['CHANGEPCT24HOUR'] > 0 ? 'green' : 'red' }}>% {this.props.assets['EOS']['USD']['CHANGEPCT24HOUR']}</td>
                        <td>Nan</td>
                    </tr>
                </tbody>
            </table>
